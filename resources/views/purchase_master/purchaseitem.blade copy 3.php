...
<div id="tabletWrapper" class="tablet-container">
    ...
    <!-- BACK BUTTON -->
    <a href="purchase_list.html" class="btn grey" style="margin-bottom:10px;">
    ...
    <div class="header-row valign-wrapper">
        <div class="header-logo">
            <img src="{{ url('images/maxposlogo.jpg') }}" alt="MaxPos Logo">
        </div>
...
<div id="editModal" class="modal">
  <div class="modal-content">
    ...
    <div id="modalUnitDiv" style="display:none; margin-bottom:10px;">
        <label>Unit:</label>
        <select id="modalUnitSelect"></select>
    </div>

    <div id="modalQtyDiv" style="display:none; display:flex; align-items:center; gap:10px;">
        <label>Qty:</label>
...
btn.addEventListener('click', ()=>{
    ...
    if(tabletMode){ setTabletLandscape(); } 
    else { wrapper.classList.remove('tablet-container'); wrapper.style.width=''; wrapper.style.minHeight=''; btn.innerText='Toggle Tablet Mode'; }
});
...
document.getElementById('modalSaveBtn').addEventListener('click', ()=>{
    ...
    if(editField==='unit'){
        ...
        item.variant_id = variant.id;           // update variant id
        item.unit = variant.unit.unit_name;     // update unit name
